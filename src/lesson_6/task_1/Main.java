...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        array.remove(a);
        System.out.println("Удален элемент = 3. Новый массив: " + Arrays.toString(array.toArray())
                + ", размер массива: " + array.size());
        array.clear();
        ...
        linkedList.remove(b);
        System.out.println("Удален элемент = 2. Новый список: " + Arrays.toString(linkedList.toArray())
                + ", размер списка: " + linkedList.size());
        linkedList.clear();
